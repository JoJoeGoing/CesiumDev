define([
    ...
    function getScreenSpacePositions(collection, points, scene, occluder, entityCluster) {
        ...
        for (var i = 0; i < length; ++i) {
            ...
            //todo:更改item.id._billboard
            var canClusterBillboards = entityCluster._clusterBillboards && defined(item);
            //todo:更改item.id._point
            var canClusterPoints = entityCluster._clusterPoints && defined(item);
