define(['../../Core/defaultValue',
    ...
    EntityCluster, MarkerLayer, Layer, MarkerCollection) {
    'use strict';
    ...
    function LayerManager(options) {
        ...
        this._collection = new MarkerCollection(this._viewer, {
            labels: labels,
    ...
    LayerManager.prototype.addCollection = function (collection) {
        ...
        for (var index = 0; index < collection.length; index++) {
            ...
            layer.markerCollection = this._collection;
    ...
    LayerManager.prototype.addQueryLayer = function (layerInfo, callback) {
        ...
        var markerLayer = new Layer(options);
        markerLayer.init();
