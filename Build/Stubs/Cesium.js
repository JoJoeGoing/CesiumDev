...
define('UMap/OptionsUtil', function() {
    return Cesium['OptionsUtil'];
});
...
define('UMap/Layer/LayerManager', function() {
    return Cesium['LayerManager'];
});

define('UMap/Layer/MarkerLayer', function() {
    return Cesium['MarkerLayer'];
});

define('UMap/Layer/WebFeatureProvider', function() {
    return Cesium['WebFeatureProvider'];
});

define('UMap/Primitive/Marker', function() {
    return Cesium['Marker'];
});
